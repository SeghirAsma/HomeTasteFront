...
function Copyright(props) {
  return (
    <Typography variant="body2" color="text.secondary" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" > Home Taste </Link>{' '}
...
export default function SignUp() {
  ...
  <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
    ...
    <TextField id="firstName" label="First Name" name="firstName" autoComplete="first-name" required autoFocus sx={{ flex: 1 }}  
      value={firstName}
    ...
    />
    <TextField id="lastName" label="Last Name" name="lastName" autoComplete="last-name" required sx={{ flex: 1 }}
      value={lastName}
...
<Box sx={{ mt: 2 }}>
    <TextField name="password" label="Password" type="password" id="password"  autoComplete="new-password" required fullWidth
      value={password}
    ...
    <Box sx={{ mt: 2 }}>
    <TextField name="phoneNumber" label="Phone Number" type="text" id="phoneNumber" autoComplete="new-phoneNumber" required fullWidth
      value={phoneNumber}
    ...
    <Box sx={{ mt: 2 }}>
    <TextField name="address" label="Address" type="text" id="address" autoComplete="new-address" required fullWidth
      value={address}
